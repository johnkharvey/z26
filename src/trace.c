...
enum {_imp, t_ac, _rel, _imm, _abs, _abs_x, _abs_y, _zero, _zero_x, _zero_y, _ind, _ind_x, _ind_y};
...
int AccessList[256] = {
   ...
   _imp, _imm,   t_ac,  _imm,   _abs,    _abs,    _abs,    _abs,
   ...
   _imp, _imm,   t_ac,  _imp,   _abs,    _abs,    _abs,    _abs,
   ...
   _imp, _ind_x, _imp, _ind_x, _zero,   _zero,   _zero,   _zero,
   _imp, _imm,   t_ac,  _imm,   _ind,    _imm,    _abs,    _abs,
