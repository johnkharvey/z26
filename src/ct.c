...
dd	PAL_colours[] = {
	...
	0x9d63d054,		/* forest (prevent auto-switch) */
        -1
};
...
dd	BS_1[] = {	// Commavid
	...
	0x5e7a5ac4,     /* Magicard (example program 3) */
	0x27e4a094,     /* Magicard (example program 4) */
	0x23e00e7c,		/* Video Life (1981) (CommaVid) [o1].a26 */
	
	-1
};

dd	BS_3[] = {	// Parker Brothers
	0x31c81c0b,		/* Lord of the Rings */
	0x63256ab7,		/* Star Wars -- return of the Jedi game 1 */
	...
	0xc8c6f350,		/* Mr. Do!'s Castle (1984) (Parker Bros) [hMF4].a26 */
	...
	0x833c9c3a,     /* Gyruss (1984) (Parker Bros) [hMF4] (PAL).a26 */
	0x74dee6d9,     /* Gyruss (1984) (Parker Bros) [hMF4].a26 */
	...
	0x361c9ac1,     /* Montezuma's Revenge PAL60 (Thomas Jentzsch hack) */
	0xa52041a1,		/* Montezuma's Revenge - Starring Panama Joe (1983) (Parker Bros) [t1].a26 */
	0xc00ec7d0,		/* Star Wars - The Arcade Game - Reversed Control Scheme (Hack).a26 */
	0x1217d1f5,		/* Tomb Bob (Montezuma's Revenge Hack).a26 */
	0x5d55826a,		/* Tomb Raider 2600 bt Riddle_of_the_Red (New Version) (Montezuma's Revenge Hack).a26 */
	0x91e48ddd,		/* Tomb Raider 2600 by Stan Jr (Montezuma's Revenge Hack).a26 */
	0xa14a378,		/* Tomb Raider in Color by Lost Monkey (Montezuma's Revenge Hack).a26 */
...
dd	BS_9[] = {	// 8K swapped
	...
	0x3695bf82,		/* Bobby Needs Food V10 (belial) (PAL).a26 */
	0x15c50dc6,		/* Bobby Needs Food V10 (belial).a26 */
	0x320fd6be,		/* Bobby Needs Food V11 (belial) (PAL).a26 */
...
dd	BS_7[] = {	// M-Network
	...
	0xcd836dda,		/* Burgertime (1982) (Mattel) [a1].a26 */
	0x5c161fe4,		/* Masters of the Universe - The Power of He-Man.bin */
	0xc3394ca8,		/* Masters of the Universe - The Power of He-Man (1983) (Mattel) [hMF4].a26 */
//	0x79903f8c,		/* Quest for the Lost Pyramids of Atlantis Demo Screens (SeaGtGruff).a26 */
	0x3c60e917,		/* spin_e7.bin */
	0x967bc57c,		/* Sudoku 07-17-06 (PD) (PAL).a26 */
	0x1a3845f2,		/* Sudoku 7-07-06 (PD) [a1].a26 */
...
dd	BS_8[] = {
	...
	0x58748386, 	/* Fatal Run */
	0xcbb09b85,
	0x75220fe4,		/* Fatal Run (1990) (Atari) [f1] (NTSC by TJ).a26 */
	0x24f2803d,		/* Strat-O-Gems 2005-12-11 beta (John Payson).a26 */
	0x5e0fb812,		/* Strat-O-Gems 2005-12-11b beta (John Payson).a26 */
	0x85d29f7,		/* Strat-O-Gems 2005-12-12 beta (John Payson).a26 */
	0x42e82b7b,		/* Strat-O-Gems 2005-12-15 beta (John Payson) (PAL) [a1].a26 */
	0xc7c26103,		/* Strat-O-Gems 2005-12-15 beta (John Payson) (PAL).a26 */
	0xfb4e0ca3,		/* Strat-O-Gems 2005-12-16 beta (John Payson).a26 */
	0xe9d5ada0,		/* Strat-O-Gems 2005-12-18 (John Payson) (PAL).a26 */
	0x40ac4b62,		/* Strat-O-Gems 2005-12-18 final beta (John Payson).a26 */
	0x29114d33,		/* Strat-O-Gems 2005-12-18a (John Payson).a26 */
	-1
};
