...
extern int P0_Position;
extern int P1_Position;
extern int M0_Position;
extern int M1_Position;
extern int BL_Position;
extern int P0_Graphics;
extern int P1_Graphics;
