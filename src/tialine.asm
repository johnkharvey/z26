...
Init_TIA:
 	...
 	mov	dword [P0_Position],228-68
 	mov	dword [P1_Position],228-68
 	mov	dword [M0_Position],228-68
 	mov	dword [M1_Position],228-68
 	mov	dword [BL_Position],228-68
...
%endif
	...
	jz near NotCosmic
 	...
 	push	dword [M0_Motion]
 	mov	dword [M0_Motion],17		; (17)
	DoMotion  M0
 	pop	dword [M0_Motion]
